...
Lobby.downloadData = Downloadmanager:new("metafiles/meta_lobby.xml", Lobby)
...
function Lobby:onPlayerJoin (player)
    Lobby.downloadData:sendToClient(player)
end

function Lobby:onPlayerDownloadFinished (player)
