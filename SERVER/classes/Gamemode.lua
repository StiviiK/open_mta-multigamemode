...
-- TESTS
local newgamemode = Gamemode{1, "myNewGamemode", "This is a test gamemode!", nil, 32, 1, {0, 0, 0, 21}, {0, 0, 3, "cylinder", 1}} -- Register a new Gamemode
newgamemode:addPlayer(getRandomPlayer()) -- set the player in our new gamemode
--Gamemode:getGamemodeFromID(1):addPlayer(getRandomPlayer())
